...
namespace LP
{
    class LabelEdgeGrec : Label
    {
        ...
        public LabelEdgeGrec(int freq, double _alpha, double _edgeCosts)
        {
            frequency = freq;
            this.alpha = _alpha;
        ...
        {
            if (label is LabelEdgeGrec)
            {
                int startFreq = this.frequency;
                int endFreq = ((LabelEdgeGrec)label).frequency;
                ...
                for (int i = 0; i < startFreq; i++)
                {
                    ...
                    {
                        String endType = ((LabelEdgeGrec)label).type[j];
